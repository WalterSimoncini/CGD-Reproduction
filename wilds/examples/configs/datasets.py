dataset_defaults = {
    ...
    'celebA': {
        ...
        'optimizer_kwargs': {'momentum': 0.9},
        'scheduler': None,
        'batch_size': 8,  # This was adjusted from 64 because of lack of resources
        'lr': 0.001,  # Didn't use the one in group-DRO repo because it was not in the range (0,0001)
        'weight_decay': 0.0001,  # From group-DRO repo
    ...
    'multiNLI': {
        'split_scheme': 'official',
        'model': 'distilbert-base-uncased',
        # 'transform': bert,  # No bert because data already tokenized
        'loss_function': 'cross_entropy',
        'groupby_fields': ['sentence2_has_negation'],
        'val_metric': 'acc_wg',
        'val_metric_decreasing': False,
        'algo_log_metric': 'accuracy',
        'max_token_length': 512,
        ...
        'optimizer_kwargs': {'momentum': 0.9},
        'scheduler': None,
        'batch_size': 8,  # Adjusted from 128
        'lr': 1e-5,  # It was 2e-5 in the group-DRO repo but it was not in the range
        'weight_decay': 0.0001,  # It was 0 in the group-DRO repo but it was not in the range
        'n_epochs': 3,  # From group-DRO
        'process_outputs_function': 'multiclass_logits_to_pred',
