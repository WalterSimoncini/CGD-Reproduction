...
def main():
    ...
    # CG specific arguments
    parser.add_argument('--cg_C', type=float, default=0)  # We choose the default value as 0 based on the C of the CGD paper, p.7 "Hyperparameters" for most models
    parser.add_argument('--cg_step_size', type=float, default=0.05)  # The value is in the WILDS leaderboard
